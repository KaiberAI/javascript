# Kaiber JavaScript Style Guide

*A mostly reasonable approach to JavaScript. Forked from [Airbnb's Javascript Style Guide](https://github.com/airbnb/javascript).*
